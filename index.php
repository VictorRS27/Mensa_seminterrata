...
<header class="main_h">
    ...
    <ul class="nav justify-content" style="margin-top:15px; margin-left:20%">
      <li class="nav-item">
        <a class="nav-link active" href="#" style="color:#F1D076">INÍCIO</a>
      </li>
      <li class="nav-item">
...
<hr style="background: #000000; margin-top: 0px; margin-bottom: 0px">
<img src="imgoutros/desc.png" width="100%"/>
<hr style="background: #000000; margin-top: 0px; margin-bottom: 0px">
