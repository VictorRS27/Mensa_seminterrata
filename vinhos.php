...
<head>
  <meta charset="UTF-8">
  <title>Mensa Seminterrata | Vinhos</title>
...
<header class="main_h">
    ...
    <ul class="nav justify-content" style="margin-top:15px; margin-left:20%">
      ...
      <li class="nav-item">
        <a class="nav-link" href="#" style="color:#F1D076">VINHOS</a>
      </li>
      <li class="nav-item">
        <a class="nav-link active" href="#" style="color:#F1D076">•</a>
      </li>
...
<br><br>
<center>
<img src="imgoutros/suttername.png" width="80%"/>
</center>
<br><br>

<div class="card-group">
  <div class="card" style="margin-left: 2%; margin-right: 2%; background: #670000">
    <img class="card-img-top" src="imgvinhos/vinhosbg1.png" style="width: 100%; margin-left:0px" alt="Imagem de capa do card">
    <div class="card-body">
    </div>
  </div>
  <?php
  include("connection.php");
  @$consulta = mysqli_query($con, "select * from produtos where id = '58'");
  ...
  ';
  @$consulta = mysqli_query($con, "select * from produtos where id = '59'");
  @$dados = mysqli_fetch_array($consulta);
  echo'
    <div class="card" style="margin-left: 2%; margin-right: 2%">
      <form action="ligacao.php" method="POST">
  ...
  ';
  @$consulta = mysqli_query($con, "select * from produtos where id = '60'");
  @$dados = mysqli_fetch_array($consulta);
  echo'  
    <div class="card" style="margin-left: 2%; margin-right: 2%">
      <form action="ligacao.php" method="POST">
...
<br><br>
<center>
<img src="imgoutros/yaganname.png" width="80%"/>
</center>
<br><br>
...
<?php
  include("connection.php");
  @$consulta = mysqli_query($con, "select * from produtos where id = '43'");
  @$dados = mysqli_fetch_array($consulta);
  echo'
    <div class="card" style="margin-left: 2%; margin-right: 2%">
      <form action="ligacao.php" method="POST">
  ...
  ';
  @$consulta = mysqli_query($con, "select * from produtos where id = '44'");
  @$dados = mysqli_fetch_array($consulta);
  echo'
    <div class="card" style="margin-left: 2%; margin-right: 2%">
      <form action="ligacao.php" method="POST">
  ...
  ';
  @$consulta = mysqli_query($con, "select * from produtos where id = '45'");
  @$dados = mysqli_fetch_array($consulta);
  echo'  
    <div class="card" style="margin-left: 2%; margin-right: 2%">
      <form action="ligacao.php" method="POST">
  ...
  ';?>
    <div class="card" style="margin-left: 2%; margin-right: 2%; background: #670000">
      <img class="card-img-top" src="imgvinhos/vinhosbg2.png" style="width: 100%; margin-left:0px" alt="Imagem de capa do card">
      <div class="card-body">
      </div>
    </div>
  </div>
  ...
  <br><br>
  <center>
  <img src="imgoutros/copperlandname.png" width="80%"/>
  </center>
  <br><br>

  <div class="card-group">
    <div class="card" style="margin-left: 2%; margin-right: 2%; background: #670000">
      <img class="card-img-top" src="imgvinhos/vinhosbg3.png" style="width: 100%; margin-left:0px" alt="Imagem de capa do card">
      <div class="card-body">
      </div>
    </div>
    <?php
  include("connection.php");
  @$consulta = mysqli_query($con, "select * from produtos where id = '46'");
  @$dados = mysqli_fetch_array($consulta);
  echo'
    <div class="card" style="margin-left: 2%; margin-right: 2%">
      <form action="ligacao.php" method="POST">
  ...
  ';
  @$consulta = mysqli_query($con, "select * from produtos where id = '47'");
  @$dados = mysqli_fetch_array($consulta);
  echo'
    <div class="card" style="margin-left: 2%; margin-right: 2%">
      <form action="ligacao.php" method="POST">
  ...
  ';
  @$consulta = mysqli_query($con, "select * from produtos where id = '48'");
  @$dados = mysqli_fetch_array($consulta);
  echo'  
    <div class="card" style="margin-left: 2%; margin-right: 2%">
      <form action="ligacao.php" method="POST">
