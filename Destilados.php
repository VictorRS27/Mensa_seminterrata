...
<head>
  <meta charset="UTF-8">
  <title>Mensa Seminterrata | Destilados</title>
...
<br><br>
<center>
<img src="imgoutros/whiskyname.png" width="80%"/>
</center>
<br><br>

<div class="card-group">
  <div class="card" style="margin-left: 2%; margin-right: 2%; background: #670000">
    <img class="card-img-top" src="imgdestil/destilbg1.png" style="width: 100%; margin-left:0px" alt="Imagem de capa do card">
    <div class="card-body">
    </div>
  </div>
  <?php
  include("connection.php");
  @$consulta = mysqli_query($con, "select * from produtos where id = '49'");
  ...
  @$consulta = mysqli_query($con, "select * from produtos where id = '50'");
  @$dados = mysqli_fetch_array($consulta);
  echo'
  <div class="card" style="margin-left: 2%; margin-right: 2%">
  <form action="ligacao.php" method="POST">
  ...
  @$consulta = mysqli_query($con, "select * from produtos where id = '51'");
  @$dados = mysqli_fetch_array($consulta);
  echo'
  <div class="card" style="margin-left: 2%; margin-right: 2%">
  <form action="ligacao.php" method="POST">
...
<br><br>
<center>
<img src="imgoutros/vodkaname.png" width="80%"/>
</center>
<br><br>
...
<?php
  include("connection.php");
  @$consulta = mysqli_query($con, "select * from produtos where id = '52'");
  @$dados = mysqli_fetch_array($consulta);
  echo'
  <div class="card" style="margin-left: 2%; margin-right: 2%">
  <form action="ligacao.php" method="POST">
  ...
  @$consulta = mysqli_query($con, "select * from produtos where id = '53'");
  @$dados = mysqli_fetch_array($consulta);
  echo'
  <div class="card" style="margin-left: 2%; margin-right: 2%">
  <form action="ligacao.php" method="POST">
  ...
  @$consulta = mysqli_query($con, "select * from produtos where id = '54'");
  @$dados = mysqli_fetch_array($consulta);
  echo'
  <div class="card" style="margin-left: 2%; margin-right: 2%">
  <form action="ligacao.php" method="POST">
    ...
    <div class="card" style="margin-left: 2%; margin-right: 2%; background: #670000">
      <img class="card-img-top" src="imgdestil/destilbg2.png" style="width: 100%; margin-left:0px" alt="Imagem de capa do card">
      <div class="card-body">
      </div>
    </div>
  </div>
  ...
  <br><br>
  <center>
  <img src="imgoutros/outrosname.png" width="80%"/>
  </center>
  <br><br>

  <div class="card-group">
    <div class="card" style="margin-left: 2%; margin-right: 2%; background: #670000">
      <img class="card-img-top" src="imgdestil/destilbg3.png" style="width: 100%; margin-left:0px" alt="Imagem de capa do card">
      <div class="card-body">
      </div>
    </div>
    <?php
  include("connection.php");
  @$consulta = mysqli_query($con, "select * from produtos where id = '55'");
  @$dados = mysqli_fetch_array($consulta);
  echo'
  <div class="card" style="margin-left: 2%; margin-right: 2%">
  <form action="ligacao.php" method="POST">
  ...
  @$consulta = mysqli_query($con, "select * from produtos where id = '56'");
  @$dados = mysqli_fetch_array($consulta);
  echo'
  <div class="card" style="margin-left: 2%; margin-right: 2%">
  <form action="ligacao.php" method="POST">
  ...
  @$consulta = mysqli_query($con, "select * from produtos where id = '57'");
  @$dados = mysqli_fetch_array($consulta);
  echo'
  <div class="card" style="margin-left: 2%; margin-right: 2%">
  <form action="ligacao.php" method="POST">
